...
namespace Hydra.Win.Layouts
{
    ...
    {/*
        ...
        */
        ...
        public static bool DeleteUrlCache(string urlName)
        {
            IntPtr lpszUrlName = Marshal.StringToHGlobalAnsi(urlName);

            bool r = SysWin32.DeleteUrlCacheEntry(lpszUrlName);
            return r;
        }
        */
        ...
        public static void clearIECache()
        {
            ...
            // DirectoryInfo folder = new DirectoryInfo(@"C:\Users\dob\AppData\Local\Microsoft\Windows\Temporary Internet Files\");
            ...
            {
                // FileAttributes attributes = file.Attributes; // File.GetAttributes(path);
                try
                {
