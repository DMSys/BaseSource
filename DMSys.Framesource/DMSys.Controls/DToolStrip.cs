...
namespace Messir.Windows.Forms
{
    ...
    /// <summary>
    /// Represents a DToolStrip control
    /// </summary>
    public class DToolStrip : ToolStrip
    {
        ...
        public DToolStrip(params TabStripButton[] buttons)
            : base(buttons)
        {
            InitControl();
        }
        ...
        /// <summary>
        /// Gets custom renderer for DToolStrip. Set operation has no effect
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets layout style for DToolStrip control
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets render style for DToolStrip, use it instead of 
        /// </summary>
        [Category("Appearance")]
        [Description("Gets or sets render style for DToolStrip. You should use this property instead of RenderMode.")]
        ...
        /// </summary>
        [Category("Appearance")]
        [Description("Specifies if DToolStrip should use system visual styles for painting items")]
        ...
        /// </summary>
        [Category("Appearance")]
        [Description("Specifies if TabButtons should be drawn flipped (for right- and bottom-aligned DToolStrips)")]
        ...
        public TabStripButton SelectedTab
        {
            ...
            set
            {
                ...
                if (mySelTab == value)
                    return;
                if (value.Owner != this)
                    throw new ArgumentException("Cannot select TabButtons that do not belong to this DToolStrip");
    ...
    /// <summary>
    /// Represents a renderer class for DToolStrip control
    /// </summary>
    internal class TabStripRenderer : ToolStripRenderer
    {
        ...
        private Padding _TSRPadding = new Padding(14, 0, 0, 0);
        ...
        protected override void OnRenderToolStripBorder(ToolStripRenderEventArgs e)
        {
            ...
            using (Pen p2 = new Pen(e.BackColor))
            {
                ...
                foreach (ToolStripItem x in e.ToolStrip.Items)
                {
                    ...
                    if (e.ToolStrip.Orientation == Orientation.Horizontal)
                    {
                        Rectangle rr = x.Bounds;
                        rr.X = rr.X + (rr.Width - 13);
                        rr.Y = rr.Y + ((rr.Height / 2) - 3);
                        rr.Width = 6;
                        rr.Height = 6;
                        Brush bb = new SolidBrush(Color.Red);
                        Pen pp = new Pen(bb);
                        pp.Width = (float)2;
                        e.Graphics.DrawLine(pp, rr.X, rr.Y, rr.X + rr.Width, rr.Y + rr.Height);
                        e.Graphics.DrawLine(pp, rr.X + rr.Width, rr.Y, rr.X, rr.Y + rr.Height);

                        btn.Padding = _TSRPadding;
                        //
        ...
        protected override void OnRenderButtonBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            DToolStrip tabs = e.ToolStrip as DToolStrip;
    ...
    /// <summary>
    /// Represents a TabButton for DToolStrip control
    /// </summary>
    ...
    public class TabStripButton : ToolStripButton
    {
        ...
        public bool IsSelected
        {
            get
            {
                DToolStrip owner = Owner as DToolStrip;
                if (owner != null)
        ...
        {
            if (Owner != null && !(Owner is DToolStrip))
