...
namespace DMSys.NativeMethods
{
    ...
    public static class User32
    {
        ...
        public static extern int ChangeDisplaySettings(ref Gdi32.DEVMODE devMode, int flags);
        ...
        #region bool EnumDisplaySettings([In] string lpszDeviceName, [In] Int32 iModeNum, [Out] Gdi32.DEVMODE lpDevMode)
        /// <summary>
        ...
        /// </returns>
        [DllImport(USER_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION, CharSet = CharSet.Auto, SetLastError = true), SuppressUnmanagedCodeSecurity]
        public static extern bool EnumDisplaySettings([In] string lpszDeviceName, [In] Int32 iModeNum, [Out] Gdi32.DEVMODE lpDevMode);
        #endregion bool EnumDisplaySettings([In] string lpszDeviceName, [In] Int32 iModeNum, [Out] Gdi32.DEVMODE lpDevMode)
        ...
        #region IntPtr SendMessage( [In] IntPtr hWnd, [In] UInt32 Msg, [In] IntPtr wParam, [In] IntPtr lParam)
        /// <summary>
        ...
        [DllImport(USER_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION, CharSet = CharSet.Auto, SetLastError = false), SuppressUnmanagedCodeSecurity]
        public static extern IntPtr SendMessage( [In] IntPtr hWnd, [In] UInt32 Msg, [In] IntPtr wParam, [In] IntPtr lParam);
        #endregion IntPtr SendMessage( [In] IntPtr hWnd, [In] UInt32 Msg, [In] IntPtr wParam, [In] IntPtr lParam)

        #region UInt32 RegisterWindowMessage([In] string lpString)
        /// <summary>
        ...
        /// </returns>
        [DllImport(USER_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION, CharSet = CharSet.Auto, SetLastError = false), SuppressUnmanagedCodeSecurity]
        public static extern UInt32 RegisterWindowMessage([In] string lpString);
        #endregion UInt32 RegisterWindowMessage([In] string lpString)

        #region IntPtr SendMessageTimeout([In]IntPtr hWnd, [In]UInt32 Msg, [In]UIntPtr wParam, [In]IntPtr lParam, [In]UInt32 fuFlags, [In]UInt32 uTimeout, [Out, Optional]out UIntPtr lpdwResult)
        /// <summary>
        ...
        /// <param name="fuFlags">The behavior of this function. This parameter can be one or more of the following values.</param>
        ...
        /// <param name="lpdwResult">The result of the message processing. The value of this parameter depends on the message that is specifie</param>
        /// <returns>
        ...
        /// </returns>
        [DllImport(USER_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION, CharSet = CharSet.Auto, SetLastError = false), SuppressUnmanagedCodeSecurity]
        public static extern IntPtr SendMessageTimeout([In]IntPtr hWnd, [In]UInt32 Msg, [In]UIntPtr wParam, [In]IntPtr lParam, [In]UInt32 fuFlags, [In]UInt32 uTimeout, [Out, Optional]out UIntPtr lpdwResult);

        [DllImport(USER_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION, CharSet = CharSet.Auto, SetLastError = false), SuppressUnmanagedCodeSecurity]
        public static extern IntPtr SendMessageTimeout([In]IntPtr hWnd, [In]UInt32 Msg, [In]IntPtr wParam, [In]ref CopyDataStruct lParam, [In]SendMessageTimeoutFlags fuFlags, [In]UInt32 uTimeout, [Out, Optional]out IntPtr lpdwResult);

        [DllImport(USER_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION, CharSet = CharSet.Auto, SetLastError = false), SuppressUnmanagedCodeSecurity]
        public static extern IntPtr SendMessageTimeout([In]IntPtr hWnd, [In]UInt32 Msg, [In]IntPtr wParam, [In]IntPtr lParam, [In]SendMessageTimeoutFlags fuFlags, [In]UInt32 uTimeout, [Out, Optional]out IntPtr lpdwResult);
        #endregion IntPtr SendMessageTimeout([In]IntPtr hWnd, [In]UInt32 Msg, [In]UIntPtr wParam, [In]IntPtr lParam, [In]UInt32 fuFlags, [In]UInt32 uTimeout, [Out, Optional]out UIntPtr lpdwResult)
    }
}
