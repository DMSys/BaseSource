...
namespace DMSys.NativeMethods
{
    ...
    public static class Kernel32
    {
        ...
        #region IntPtr LoadLibraryEx([In]string lpFileName, IntPtr hFile, [In]uint dwFlags)
        /// <summary>
        /// Maps the specified executable module into the address space of the calling process.
        /// </summary>
        /// <param name="lpFileName">
        ///     <para>The name of the module. This can be a library module (a .dll file) or an executable module (an .exe file). This name is the file name of the module; it is not related to the name stored in a library module itself, as specified by the LIBRARY keyword in the module-definition (.def) file.</para>
        ///     <para>If the string specifies a full path, the function searches only that path for the module.</para>
        ///     <para>If the string specifies module name without a path or with a relative path, the function uses a standard search strategy to find the module; for more information, see Remarks.</para>
        ...
        ///     <para>If loading the specified module into the address space causes the system to load other associated modules, the function can use either the standard search strategy or an alternate search strategy to find those modules. See the Remarks for more information.</para>
        ///     <para>If the specified module is an .exe file, static imports are not loaded; instead, the module is loaded as if DONT_RESOLVE_DLL_REFERENCES was specified. See the dwFlags parameter for more information.</para>
        /// </param>
        /// <param name="hFile">This parameter is reserved for future use. It must be NULL.</param>
        /// <param name="dwFlags">
        ///     <para>The action to be taken when loading the module. If no flags are specified, the behavior of this function is identical to that of the LoadLibrary function. This parameter can be one of the following values.</para>
        ///     <para>
        ///         <list type="table">
        ///             <listheader>
        ///                 <term>Value</term>
        ...
        ///             </listheader>
        ///             <item>
        ///                 <term><para>DONT_RESOLVE_DLL_REFERENCES</para><para>0x00000001</para></term>
        ///                 <description>	
        ///                     <para>If this value is used, and the executable module is a DLL, the system does not call DllMain for process and thread initialization and termination. Also, the system does not load additional executable modules that are referenced by the specified module.</para>
        ///                     <para>Note  Do not use this value; it is provided only for backwards compatibility. If you are planning to access only data or resources in the DLL, use LOAD_LIBRARY_AS_DATAFILE_EXCLUSIVE or LOAD_LIBRARY_AS_IMAGE_RESOURCE or both. Otherwise, load the library as a DLL or executable module using the LoadLibrary function.</para>
        ///                 </description>
        ///             </item>
        ///             <item>
        ///                 <term><para>LOAD_IGNORE_CODE_AUTHZ_LEVEL</para><para>0x00000010</para></term>
        ///                 <description>
        ///                     <para>If this value is used, the system does not check AppLocker rules or apply Software Restriction Policies for the DLL. This action applies only to the DLL being loaded and not to its dependents. This value is recommended for use in setup programs that must run extracted DLLs during installation.</para>
        ///                     <para>Windows Server 2008, Windows Vista, Windows Server 2003, and Windows XP:  AppLocker was introduced in Windows 7 and Windows Server 2008 R2.</para>
        ///                     <para>Windows 2000:  This value is not supported until Windows XP.</para>
        ///                 </description>
        ///             </item>
        ///             <item>
        ///                 <term><para>LOAD_LIBRARY_AS_DATAFILE</para><para>0x00000002</para></term>
        ///                 <description>
        ...
        ///             </item>
        ///             <item>
        ///                 <term><para>LOAD_LIBRARY_AS_DATAFILE_EXCLUSIVE</para><para>0x00000040</para></term>
        ///                 <description>	
        ...
        ///                     <para>This value can be used with LOAD_LIBRARY_AS_IMAGE_RESOURCE. For more information, see Remarks.</para>
        ///                     <para>Windows Server 2003 and Windows XP/2000:  This value is not supported until Windows Vista.</para>
        ///                 </description>
        ///             </item>
        ///             <item>
        ///                 <term><para>LOAD_LIBRARY_AS_IMAGE_RESOURCE</para><para>0x00000020</para></term>
        ///                 <description>
        ...
        ///             </item>
        ///             <item>
        ///                 <term><para>LOAD_WITH_ALTERED_SEARCH_PATH</para><para>0x00000008</para></term>
        ///                 <description>	
        ///                     <para>If this value is used and lpFileName specifies an absolute path, the system uses the alternate file search strategy discussed in the Remarks section to find associated executable modules that the specified module causes to be loaded. If this value is used and lpFileName specifies a relative path, the behavior is undefined.</para>
        ///                     <para>If this value is not used, or if lpFileName does not specify a path, the system uses the standard search strategy discussed in the Remarks section to find associated executable modules that the specified module causes to be loaded.</para>
        ///                 </description>
        ///             </item>
        ///         </list>
        ///     </para>
        ...
        /// </returns>
        [DllImport(KERNEL_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION, SetLastError = true), SuppressUnmanagedCodeSecurity]
        public static extern IntPtr LoadLibraryEx([In]string lpFileName, IntPtr hFile, [In]uint dwFlags);
        #endregion IntPtr LoadLibraryEx([In]string lpFileName, IntPtr hFile, [In]uint dwFlags)

        #region bool GetModuleHandleEx([In]UInt32 dwFlags, [In, Optional] string lpModuleName, [Out] IntPtr phModule)
        /// <summary>
        ...
        ///             <item>
        ///                 <term>0</term>
        ///                 <description>Increment the reference count. This is the default case.The caller must use the FreeLibrary function when they have finished using the module handle.</description>
        ///             </item>
        ///             <item>
        ///                 <term><para>GET_MODULE_HANDLE_EX_FLAG_FROM_ADDRESS</para><para>0x00000004</para></term>
        ///                 <description>The lpModuleName parameter is an address in the module.</description>
        ///             </item>
        ///             <item>
        ///                 <term><para>GET_MODULE_HANDLE_EX_FLAG_PIN</para><para>0x00000001</para></term>
        ///                 <description>The module stays loaded until the process is terminated, no matter how many times FreeLibrary is called. This option cannot be used with GET_MODULE_HANDLE_EX_FLAG_UNCHANGED_REFCOUNT.</description>
        ///             </item>
        ///             <item>
        ///                 <term><para>GET_MODULE_HANDLE_EX_FLAG_UNCHANGED_REFCOUNT</para><para>0x00000002</para></term>
        ///                 <description>Do not increment the reference count for the module. This option is equivalent to the behavior of GetModuleHandle. This option cannot be used with GET_MODULE_HANDLE_EX_FLAG_PIN.</description>
        ///             </item>
        ///         </list>
        ///     </para>
        /// </param>
        ...
        ///     <para>The GetModuleHandleEx function does not retrieve handles for modules that were loaded using the LOAD_LIBRARY_AS_DATAFILE flag. For more information, see LoadLibraryEx.</para>
        /// </param>
        /// <returns>
        ///     <para>If the function succeeds, the return value is nonzero.</para>
        ///     <para>If the function fails, the return value is zero. To get extended error information, see GetLastError.</para>
        /// </returns>
        [DllImport(KERNEL_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION, SetLastError = true, CharSet = CharSet.Unicode, ThrowOnUnmappableChar = true), SuppressUnmanagedCodeSecurity]
        public static extern bool GetModuleHandleEx([In]UInt32 dwFlags, [In, Optional] string lpModuleName, [Out] IntPtr phModule);
        #endregion bool GetModuleHandleEx([In]UInt32 dwFlags, [In, Optional] string lpModuleName, [Out] IntPtr phModule)

        #region int GetPrivateProfileString([In]string lpAppName, [In]string lpKeyName, [In]string lpDefault, [In, Out] char[] lpReturnedString, [In]int nSize, [In]string lpFileName)
        /// <summary>
        ///     <para>Retrieves a string from the specified section in an initialization file.</para>
        ///     <para>Note: This function is provided only for compatibility with 16-bit Windows-based applications. Applications should store initialization information in the registry.</para>
        /// </summary>
        ...
        ///     <para>A default string. If the lpKeyName key cannot be found in the initialization file, GetPrivateProfileString copies the default string to the lpReturnedString buffer. If this parameter is NULL, the default is an empty string, ''.</para>
        ///     <para>Avoid specifying a default string with trailing blank characters. The function inserts a null character in the lpReturnedString buffer to strip any trailing blanks.</para>
        ///  </param>
        ...
        /// </returns>
        [DllImport(KERNEL_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION, SetLastError = true, CharSet = CharSet.Unicode, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
        public static extern int GetPrivateProfileString([In]string lpAppName, [In]string lpKeyName, [In]string lpDefault, [In, Out] char[] lpReturnedString, [In]int nSize, [In]string lpFileName);
        #endregion int GetPrivateProfileString([In]string lpAppName, [In]string lpKeyName, [In]string lpDefault, [In, Out] char[] lpReturnedString, [In]int nSize, [In]string lpFileName)

        #region bool WritePrivateProfileString( [In] string lpAppName, [In] string lpKeyName, [In] string lpString, [In] string lpFileName)
        /// <summary>
        ///     <para>Copies a string into the specified section of an initialization file.</para>
        ///     <para>Note  This function is provided only for compatibility with 16-bit versions of Windows. Applications should store initialization information in the registry.</para>
        /// </summary>
        ...
        ///     <para>If the function fails, or if it flushes the cached version of the most recently accessed initialization file, the return value is zero. To get extended error information, call GetLastError.</para>
        /// </returns>
        [DllImport(KERNEL_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION, SetLastError = true, ExactSpelling = true, CharSet = CharSet.Auto), SuppressUnmanagedCodeSecurity]
        public static extern bool WritePrivateProfileString( [In] string lpAppName,
                                                             [In] string lpKeyName,
                                                             [In] string lpString,
                                                             [In] string lpFileName);
        #endregion bool WritePrivateProfileString( [In] string lpAppName, [In] string lpKeyName, [In] string lpString, [In] string lpFileName)

        #region int GetShortPathName( [In] string lpszLongPath, [Out] StringBuilder lpszShortPath, [In] uint cchBuffer)
        /// <summary>
        ...
        ///     <para>Passing NULL for this parameter and zero for cchBuffer will always return the required buffer size for a specified lpszLongPath.</para>
        /// </param>
        /// <param name="cchBuffer">
        ///     <para>The size of the buffer that lpszShortPath points to, in TCHARs.</para>
        ///     <para>Set this parameter to zero if lpszShortPath is set to NULL.</para>
        /// </param>
        /// <returns>
        ...
        /// </returns>
        [DllImport(KERNEL_NATIVE_LIBRARY, SetLastError = true, CharSet = CharSet.Auto), SuppressUnmanagedCodeSecurity]
        public static extern int GetShortPathName([MarshalAs(UnmanagedType.LPTStr), In] string lpszLongPath,
                                                  [MarshalAs(UnmanagedType.LPTStr), Out] StringBuilder lpszShortPath,
                                                  [MarshalAs(UnmanagedType.U4), In] uint cchBuffer);
        #endregion int GetShortPathName( [In] string lpszLongPath, [Out] StringBuilder lpszShortPath, [In] uint cchBuffer)
    }
}
