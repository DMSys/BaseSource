...
namespace DMSys.Net.FTP
{
    ...
    /// </remarks>
    [System.Drawing.ToolboxBitmap("FTPClient.bmp")]
    public class FTPClient : Component
    {
        ...
        public bool FtpDirectoryExists(string DirName, string FindDir)
        {
            //return a simple list of filenames in directory
            System.Net.FtpWebRequest ftp = GetRequest(GetDirectory(DirName));
            //Set request to do simple list
            ftp.Method = System.Net.WebRequestMethods.Ftp.ListDirectory;
            ...
            //replace CRLF to CR, remove last instance
            str = "\r" + str.Replace("\r\n", "\r");
            string FindDirectory = "\r" + FindDir + "\r";
            for (int i = 0; i < (str.Length - FindDirectory.Length); i++)
            {
                string dd = str.Substring(i, FindDirectory.Length);
                string ddd = dd;
                if (str.Substring(i, FindDirectory.Length).Equals(FindDirectory))
                    return true;
            }
            return false;
        }
        ...
        private FtpWebRequest GetRequest(string URI)
        {
            ...
            FtpWebRequest result = (FtpWebRequest)FtpWebRequest.Create(uriBuilder.Uri);
        ...
        private string GetDirectory(string directory)
        {
            ...
            {
                string sDirName = directory.Replace("\\","/");
                ...
                URI = this.Hostname + sDirName;
                _lastDirectory = sDirName;
            }
            return URI;
        }
