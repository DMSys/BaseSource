...
namespace DMSys.Cryptography.Zip
{
	...
	public class ZipEntry : ICloneable
	{
		...
		bool isVisible;						   // CJ: show in or hide from TOC
		...
		/// </returns>
		/// <see cref="DMSys.Cryptography.Zip.CompressionMethod.Deflated"/>
		/// <see cref="DMSys.Cryptography.Zip.CompressionMethod.Stored"/>
