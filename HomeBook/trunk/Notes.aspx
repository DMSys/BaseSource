<%@ Page Language="C#" MasterPageFile="~/design/MasterPage.master" AutoEventWireup="true" CodeFile="Notes.aspx.cs" CodeFileBaseClass="System.Web.UI.Page" Inherits="Notes" %>
...
<asp:Content ID="SheetContent" ContentPlaceHolderID="SheetContentPlaceHolder" Runat="Server">
  ...
  <nachoContent:Article ID="Article1" Caption="Бележки" runat="server"><ContentTemplate>
    <img src="Content/images/preview.jpg" alt="an image" style="float:left;" />
    
    <p>В този раздел са Вашите бележки. Тук можете да добавяте и редактирате данни. Логнете се в системата за да започнете работа.</p>
 ...
 <nachoContent:Article ID="Article3" Caption="Действия" runat="server">
     ...
     <table id="tb_action" class="nacho-article" border="0" cellspacing="0" cellpadding="0">
      <tbody>
        <tr> 
          ...
          <th><a id="addPopup" href='AddNotes.aspx?id=<%# Eval("ID") %>' title="Добавяне">Добави бележка</a></th>
   ...
   <ContentTemplate>
       ...
       <Columns>
           ...
           <ItemTemplate >
                <a id="popup" title="Редакция" href='EditNotes.aspx?id=<%# Eval("ID") %>' ><img src="Content/images/edit.png" alt="Редакция" /></a>           
           </ItemTemplate>         
           </asp:TemplateField>
            <asp:TemplateField HeaderText="">
           <ItemTemplate > 
           ...
           <asp:TemplateField HeaderText="Статус" >
                <ItemTemplate >            
                  ...
                  <asp:BoundField DataField="Note" HeaderText="Бележка"
                    SortExpression="Note" />
