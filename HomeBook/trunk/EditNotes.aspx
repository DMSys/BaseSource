<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditNotes.aspx.cs" Inherits="EditNotes" %>
...
<body>
    ...
    <ContentTemplate>
     <center><h3>Редактирайте данните</h3> <center>
           ...
           <caption>
              <p>
                  <tr>
                      ...
                      <th><asp:TextBox ID="txtID" runat="server" ReadOnly="true"></asp:TextBox>
                      </th>
                                      ...
                                      <caption>
                                          <tr>
                                              ...
                                              <th class="auto-style4">
                                                  <asp:TextBox ID="txtNotes" runat="server" Height="30px" style="margin-right: 70px" TextMode="MultiLine" width="97%"></asp:TextBox>
                                              </th>
                                              <caption>
                                                  <p>
                                                  </p>
