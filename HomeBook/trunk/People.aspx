<%@ Page Language="C#" MasterPageFile="~/design/MasterPage.master" AutoEventWireup="true" CodeFile="People.aspx.cs" CodeFileBaseClass="System.Web.UI.Page" Inherits="People" %>
...
<asp:Content ID="SheetContent" ContentPlaceHolderID="SheetContentPlaceHolder" Runat="Server">
  ...
  <nachoContent:Article ID="Article1" Caption="Живущи" runat="server">
  <ContentTemplate>
    <img src="Content/images/preview.jpg" alt="an image" style="float:left;" />
    
    <p>В този раздел са указани живущите във вашата кооперация. Тук можете да добавяте и редактирате данни.  Логнете се в системата за да започнете работа.</p>
 ...
 <nachoContent:Article ID="Article3" Caption="Действия" runat="server">
    ...
    <ContentTemplate>     
     ...
     <table class="nacho-article" border="0" cellspacing="0" cellpadding="0">
      <tbody>
        <tr> 
          <th><a id="addPopup" href='AddPeople.aspx?id=<%# Eval("ID") %>' title="Добавяне">Добави живущ</a></th>
          <th><a id="a1" href='Other/Export.aspx?ID=people' title="Експорт">Експорт в XLS</a></th>            
        </tr>
      </tbody>
     </table>     
    </ContentTemplate>
  ...
  <table id="tb_Filter" runat="server" class="nacho-article" width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody>
        <tr> 
         <th><asp:Label ID="lbl_Contactor" runat="server" Text="Контакт: "><asp:DropDownList ID="ddlContactor" runat="server"></asp:DropDownList></asp:Label>
   ...
   <ContentTemplate>
       ...
       <Columns>
           ...
           <ItemTemplate >
                <a id="popup" title="Редакция" href='EditPeople.aspx?id=<%# Eval("ID") %>' ><img src="Content/images/edit.png" alt="Редакция" /></a>           
           </ItemTemplate>         
           </asp:TemplateField>
            <asp:TemplateField HeaderText="">
           <ItemTemplate > 
           ...
           <asp:TemplateField HeaderText="Статус" >
                ...
                <asp:BoundField DataField="Address" HeaderText="Адрес"
                 ...
                 <asp:BoundField DataField="City" HeaderText="Град"
                    SortExpression="City" />
                <asp:BoundField DataField="ContactTitle" HeaderText="Контакт"
                    SortExpression="ContactTitle" />
                 <asp:BoundField DataField="Email" HeaderText="E-mail"
                    SortExpression="Email" />
                 <asp:BoundField DataField="Home" HeaderText="Апартамент"
                    SortExpression="Home" />
